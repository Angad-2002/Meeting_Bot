        ...
        return {
            ...
            "endpoints": [
                ...
                },
                {
                    ...
                    "method": "POST",
                    "description": "Webhook endpoint for MeetingBaas events",
                },
                {
                    "path": "/transcripts",
                    "method": "GET",
                    "description": "List all available meeting transcripts",
                },
                {
                    "path": "/transcripts/{meeting_id}",
                    "method": "GET",
                    "description": "Get transcript data for a specific meeting",
                },
                {
                    "path": "/transcripts/{meeting_id}/download",
                    "method": "GET",
                    "description": "Download transcript as JSON file",
                },
                {
                    "path": "/transcripts/{meeting_id}/recording",
                    "method": "GET",
                    "description": "Download meeting recording as MP4 file",
                },
